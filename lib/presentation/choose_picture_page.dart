...
class ChoosePicturePage extends StatefulWidget {
  ...
  @override
  State<ChoosePicturePage> createState() => _ChoosePicturePageState();
}
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 30),
                  Text(
                      'Вместо скучной иконки, смотрите на фото своего ребёнка'),
                  const SizedBox(height: 30),
                  GestureDetector(
                    onTap: () {
                      BlocProvider.of<RoutingBloc>(context)
                          .add(ChangeScreenEvent(4));
                    //  context.go('/picture_added_success');
                    },
                    child: Container(
                      height: 56,
                      decoration: BoxDecoration(
